...
function Initialize-ScriptAndLogging {
    ...
    $deploymentName = "TeamsChatHistoryContentSearch" # Replace this with your actual deployment name
    ...
    try {
        ...
        $Filename = "TeamsChatHistoryContentSearch"
...
$LogName = (Get-Date -Format "HHmmss") + "_TeamsChatHistoryContentSearch"
$EventSource = (Get-Date -Format "HHmmss") + "_TeamsChatHistoryContentSearch"
...
function Write-EventLogMessage {
    param (
        ...
        [string]$LogName = 'TeamsChatHistoryContentSearch',
        [string]$EventSource,
...
# # Example usage
# $LogName = 'TeamsChatHistoryContentSearchLog'
# # $ExportPath = 'Path\to\your\exported\eventlog.evtx'
# $ExportPath = "C:\code\TeamsChatHistoryContentSearch\exports\Logs\$logname.evtx"
